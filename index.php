            ...
            <div class="max-w-md">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-white text-lg leading-relaxed">
                        Streamline your business finances with our comprehensive management platform designed for modern entrepreneurs.
                    </p>
                </div>
                ...
                <div class="glass-effect rounded-2xl p-8 shadow-2xl">
                    ...
                    <form method="POST" action="" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="forgot-password.php" class="text-sm text-white hover:text-indigo-200 transition duration-200">
                                Forgot password?
                            </a>
                        </div>
