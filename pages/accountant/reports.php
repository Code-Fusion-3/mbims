...
$page_title = 'Assigned Business Reports';
...
// Get accountant's assigned businesses
$assigned_businesses_sql = "SELECT b.id, b.name 
...
if (empty($business_ids)) {
    $business_ids = [0]; // No businesses assigned
}
...
$business_performance_sql = "SELECT 
                            ...
                            WHERE $where_clause
                            GROUP BY b.id, b.name, b.business_type, u.first_name, u.last_name
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Assigned Business Reports</h1>
                <p class="text-gray-600">Financial insights for businesses you manage</p>
            </div>
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select name="business" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="">All Assigned Businesses</option>
                    <?php 
                    mysqli_data_seek($assigned_businesses_result, 0);
                    while ($business = mysqli_fetch_assoc($assigned_businesses_result)): 
                    ?>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" class="px-6 py-4 text-center text-gray-500">No business data found</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
