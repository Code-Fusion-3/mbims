    ...
    <div class="bg-white rounded-lg shadow p-6">
        <div class="flex items-center">
            ...
            <div>
                ...
                <div class="mt-2">
                    <span class="inline-flex px-3 py-1 text-sm font-semibold rounded-full <?php echo get_role_badge_class($current_user['role']); ?>">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo $user_stats['owned_businesses']; ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        ...
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-green-600"><?php echo format_currency($user_stats['total_income'] ?? 0); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-red-600"><?php echo format_currency($user_stats['total_expenses'] ?? 0); ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo $user_stats['assigned_businesses']; ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo $user_stats['total_transactions']; ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo $user_stats['businesses_worked_on']; ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900"><?php echo $user_stats['total_businesses']; ?></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            <div class="flex-shrink-0">
                                <div class="w-8 h-8 <?php echo $activity['type'] == 'income' ? 'bg-green-500' : 'bg-red-500'; ?> rounded-full flex items-center justify-center">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900">
                                    <?php echo ucfirst($activity['type']); ?> - <?php echo htmlspecialchars($activity['category_name']); ?>
                                </p>
                        ...
                        <div class="text-right">
                            <p class="text-sm font-medium <?php echo $activity['type'] == 'income' ? 'text-green-600' : 'text-red-600'; ?>">
